# Arithmetic Expression Without div
#
# Reads B, C and D and computes A = (B / C + D mod B - C) / B.
# Division and mod are implemented as subroutines using repeated
# subtraction, with sign handling for negative operands.
#
# Author: Atakan Akar
